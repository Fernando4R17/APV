  ...
  return (
    <>
      <div className="text-indigo-600 font-black text-6xl">
        <h1>Crea tu cuenta y Administra {""} <span className="text-black">tus Pacientes</span></h1>
      </div>
      ...
      <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="submit" value="Crear Cuenta" className="bg-indigo-600 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto" />
        </form>

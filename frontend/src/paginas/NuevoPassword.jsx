  ...
  return (
    <>
      <div className="text-indigo-600 font-black text-6xl">
        <h1>Reestablece tu Contraseña y no Pierdas Acceso a {""} <span className="text-black">tus Pacientes</span></h1>
      </div>
        ...
        { tokenValido && (
          <>
            <form onSubmit={handleSubmit}>
              ...
              <input type="submit" value="Guardar Nueva Contraseña" className="bg-indigo-600 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto" />
            </form>
